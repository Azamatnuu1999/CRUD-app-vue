<template>
    <li class="list-group-item d-flex  justify-content-between" :class="[{like: movie.like}, {favourite: movie.favourite}]">
        ...
        <div class="d-flex justify-content-center align-items-center">
            ...
            <button type="button" class="btn-cookie btn-sm rounded-circle" @click="$emit('onToggle',{id: movie.id, prop: 'favourite'})">
                <i class="fas fa-cookie"></i>
            </button>

            <button type="button" class="btn-trash btn-sm rounded-circle" @click="$emit('onToggle', {id: movie.id, prop: 'trash'})">
